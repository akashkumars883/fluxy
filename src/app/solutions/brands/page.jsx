          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 py-12 md:py-20 mb-8">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/login" className="px-8 py-4.5 bg-zinc-950 text-white font-bold rounded-full hover:bg-[#6366F1] hover:scale-[1.03] active:scale-[0.98] transition-all shadow-xl shadow-[#6366F1]/10 flex items-center justify-center gap-2 group text-sm">
                  Start Free
