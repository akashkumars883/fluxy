      ...
      <div className="flex items-center gap-2 sm:gap-4 shrink-0">
        <div className="hidden lg:flex items-center w-64 mr-2">
          <div className="relative w-full group cursor-pointer" onClick={onMenuClick}>
            <div className="w-full bg-zinc-50/80 hover:bg-white  border border-zinc-200 hover:border-zinc-300 rounded-xl-[14px] pl-10 pr-12 py-2 text-[13px] font-medium text-zinc-400 transition-all duration-300  hover: flex items-center h-[38px] group-hover:ring-4 group-hover:ring-zinc-50">
              Search Automixa...
            </div>
            ...
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center justify-center gap-0.5 px-2 py-0.5 rounded-xl-[6px] bg-white border border-zinc-200 text-[10px] font-semibold text-zinc-500 pointer-events-none transition-all  group-hover:bg-zinc-50">
              <span>⌘</span>
              <span>K</span>
            </div>
          </div>
