...
import { Plus, User, Globe, Play, AtSign, Users2, Link2, Copy, Check, Trash2, Sparkles } from "lucide-react";
    ...
    <div className="w-full space-y-4">
      ...
      <div className="w-full flex flex-col md:flex-row gap-5 animate-in fade-in duration-500 pb-10">
        ...
        <div className="w-full md:w-[55%] flex flex-col gap-4">
          ...
          {/* Header */}
          <div className="bg-white border border-zinc-200/80 rounded-xl p-4 sm:p-5 shadow-md shadow-zinc-200/5 flex items-center justify-between gap-2 sm:gap-3">
          ...
          {published && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 sm:p-5 flex items-center justify-between gap-2 sm:gap-3 animate-in slide-in-from-top-2">
          ...
          {/* Editor Area */}
          <div className="bg-white border border-zinc-200/80 rounded-xl p-4 sm:p-5 shadow-md shadow-zinc-200/5 flex-1">
