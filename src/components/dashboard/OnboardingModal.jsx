                ...
                {isConnecting ? (
                  ...
                  <>
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">Connect your Account</h2>
                      <p className="text-zinc-muted font-normal text-sm sm:text-base max-w-sm mx-auto px-2">
                        Connect directly via Instagram, or use Facebook Login if you manage multiple business pages.
                      </p>
                    </div>
                    ...
                    <div className="pt-1 sm:pt-2 flex flex-col items-center gap-2">
                      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        <button
                          ...
                          className="w-full sm:w-auto px-6 py-3.5 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCB045] text-white rounded-xl text-sm font-bold shadow-[0_8px_30px_-8px_rgba(253,29,29,0.4)] hover:shadow-[0_10px_40px_-10px_rgba(253,29,29,0.6)] transition-all flex items-center justify-center gap-2 hover:scale-[1.02]"
                        >
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto px-6 py-3.5 bg-[#1877F2] text-white rounded-xl text-sm font-bold shadow-[0_8px_30px_-8px_rgba(24,119,242,0.5)] hover:shadow-[0_10px_40px_-10px_rgba(24,119,242,0.7)] transition-all flex items-center justify-center gap-2 hover:scale-[1.02]"
                        >
