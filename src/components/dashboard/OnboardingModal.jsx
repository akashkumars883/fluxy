                  ...
                  <>
                    ...
                    <div className="pt-2 sm:pt-4 flex flex-col items-center gap-3">
                      <button 
                        ...
                        className="w-full sm:w-auto px-8 sm:px-12 py-3.5 sm:py-4 bg-[#6366F1] text-white rounded-xl text-sm font-bold shadow-[0_8px_30px_-8px_rgba(99,102,241,0.5)] hover:shadow-[0_10px_40px_-10px_rgba(99,102,241,0.7)] transition-all flex items-center justify-center gap-3 hover:scale-[1.02]"
                      >
                      ...
                      <div className="flex flex-col gap-1.5 sm:gap-2 items-center mt-1 sm:mt-2">
                        <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-zinc-500 font-semibold px-2 py-1">
                          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0064E0] shrink-0" viewBox="0 0 24 24" fill="currentColor">
