...
export default function AccountCard({ account, onSelect }) {
  ...
  return (
    <div
      ...
      className="cursor-pointer bg-background border border-border rounded-[32px] p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full relative overflow-hidden"
    >
