...
export default function ProfileDropdown({ user, realtimeStats, setActiveTab, onAccountSettingsClick, onSubscriptionClick }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-[calc(100vw-32px)] sm:w-[360px] bg-white border border-zinc-200 rounded-[24px] shadow-2xl py-2 z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
