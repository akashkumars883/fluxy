    ...
    <section id="cta" className="w-full bg-transparent py-24 px-4 sm:px-6 md:px-8 relative overflow-hidden flex justify-center">
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 md:px-16 relative z-10">
        ...
        <motion.div
          ...
          className="relative rounded-sm px-6 sm:px-10 md:px-14 py-12 md:py-16 bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 border border-indigo-500/20 shadow-none overflow-hidden flex flex-col md:flex-row md:items-center md:justify-between gap-6 sm:gap-10 group/main"
        >
          {/* SVG Noise Overlay */}
          <div
          ...
          {/* Inner Ambient Glow Spots Removed for Minimal Flat Aesthetic */}

          {/* Left Side: Info Details */}
          <div className="relative z-10 text-left space-y-3 max-w-3xl">
            {/* Tagline label */}
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 border border-white/20 rounded-full text-[11px] uppercase tracking-widest font-semibold text-white mb-2 font-mono">
              Get Started Now
            </div>
          ...
          <div className="relative z-10 shrink-0">
            <Link
              href="/login"
              className="inline-flex items-center gap-3 px-8 py-4 bg-white text-indigo-700 font-bold text-xs sm:text-sm rounded-full hover:bg-zinc-50 transition-all shadow-xl shadow-black/30 group/btn"
            >
