...
export default function Footer() {
  ...
  return (
    <footer className="pt-12 pb-16 md:pt-16 md:pb-20 px-6 md:px-10 border-t border-white/[0.06] bg-gradient-to-b from-[#09090C] via-[#040407] to-[#010102] text-zinc-400 relative overflow-hidden">
      ...
      <div className="max-w-8xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16 relative z-10">
        ...
        <div className="space-y-6 max-w-sm">
          ...
          <div className="space-y-3.5 pt-2">
            <a 
              href="mailto:support@automixa.in" 
              className="text-sm font-semibold text-zinc-300 hover:text-[#6366F1] transition-all duration-300 inline-block w-fit"
            >
              support@automixa.in
            </a>
            
            <div className="flex gap-4 pt-1 text-zinc-500">
              <a href="https://instagram.com/automixa.in" target="_blank" rel="noreferrer" aria-label="Instagram" className="hover:text-[#E1306C] hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
              ...
              <a href="https://facebook.com/automixa" target="_blank" rel="noreferrer" aria-label="Facebook" className="hover:text-[#1877F2] hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
              ...
              <a href="https://twitter.com/automixain" target="_blank" rel="noreferrer" aria-label="X (Twitter)" className="hover:text-white hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
              ...
              <a href="https://pinterest.com/automixain" target="_blank" rel="noreferrer" aria-label="Pinterest" className="hover:text-[#E60023] hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2 pt-4 text-xs font-semibold text-zinc-500">
              ...
              <Link href="/shield" className="flex items-center gap-1.5 hover:text-white transition-colors duration-300">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-10 sm:gap-10 md:flex md:flex-wrap md:gap-16 lg:gap-20 justify-start lg:justify-end flex-1 w-full">
             ...
             <div className="flex flex-col gap-3 text-sm font-medium">
                {productLinks.map((link, idx) => (
                  <Link 
                    key={idx}
                    href={link.href} 
                    className="text-zinc-400 hover:text-white hover:translate-x-1 transition-all duration-300 inline-block w-fit"
                  >
                    {link.label}
                  </Link>
                ))}
          ...
          {/* Links: Features */}
          <div className="space-y-4 min-w-[120px]">
             <h4 className="text-xs font-bold text-zinc-200 uppercase tracking-widest">Features</h4>
             <div className="flex flex-col gap-3 text-sm font-medium">
          ...
          <div className="space-y-4 min-w-[120px]">
             <h4 className="text-xs font-bold text-zinc-200 uppercase tracking-widest">Solutions</h4>
             <div className="flex flex-col gap-3 text-sm font-medium">
          ...
          {/* Links: Compare */}
          <div className="space-y-4 min-w-[120px]">
             <h4 className="text-xs font-bold text-zinc-200 uppercase tracking-widest">Compare</h4>
             <div className="flex flex-col gap-3 text-sm font-medium">
      ...
      <div className="max-w-8xl mx-auto mt-12 md:mt-16 pt-6 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-6 relative z-10 text-xs sm:text-sm font-normal text-zinc-500">
         <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="opacity-80 hover:opacity-100 transition-opacity shrink-0">
                ...
                >
                  <img 
                    src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1140210&theme=dark&t=1779188678299" 
         ...
         <div className="flex flex-wrap items-center gap-x-4 sm:gap-x-6 gap-y-1.5 text-xs font-normal text-zinc-500">
            ...
            <span className="text-zinc-800 hidden sm:inline">•</span>
            <Link href="/data-deletion" className="hover:text-white transition-colors duration-300">
              Data Deletion
            </Link>
         </div>
      </div>
