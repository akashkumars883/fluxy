  ...
  return (
    <footer className="pt-10 pb-16 md:pt-16 md:pb-20 px-6 md:px-10 border-t border-zinc-200/40 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-8xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16 relative z-10">
        ...
        {/* Links Area (RIGHT) */}
        <div className="flex flex-wrap gap-10 md:gap-16 lg:gap-20 justify-start lg:justify-end flex-1 w-full">
          ...
          <div className="space-y-4 min-w-[160px]">
             <h4 className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Contact</h4>
             <div className="flex flex-col gap-3 text-sm font-medium text-zinc-500">
                <a 
                  href="mailto:info@automixa.in" 
                  className="hover:text-[#6366F1] hover:translate-x-1 transition-all duration-300 inline-block w-fit"
                >
                  info@automixa.in
                </a>
                <a 
                ...
                <div className="flex gap-4 pt-3 text-zinc-400">
                  ...
                  <a href="#" target="_blank" rel="noreferrer" aria-label="X (Twitter)" className="hover:text-foreground hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
                    <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
                  </a>
