        ...
        <div className="space-y-6 max-w-sm">
          ...
          <div className="space-y-3.5 pt-2">
            ...
            <div className="flex gap-4 pt-1 text-zinc-400">
              ...
              <a href="https://twitter.com/automixain" target="_blank" rel="noreferrer" aria-label="X (Twitter)" className="hover:text-foreground hover:-translate-y-1 hover:scale-110 transition-all duration-300 cursor-pointer">
